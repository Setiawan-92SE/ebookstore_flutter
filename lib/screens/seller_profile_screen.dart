      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            CircleAvatar(
              radius: 48,
              backgroundColor: const Color(0xFFB8973A).withValues(alpha: 0.2),
              child: const Icon(Icons.store, size: 40, color: Color(0xFFB8973A)),
            ),
            ...
            Container(
              ...
              child: const Text('SELLER', style: TextStyle(color: Color(0xFFB8973A), fontSize: 12, fontWeight: FontWeight.bold, letterSpacing: 1)),
            ),
            const SizedBox(height: 40),
