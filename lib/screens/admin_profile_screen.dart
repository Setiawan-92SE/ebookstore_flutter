        ...
        child: Column(
          children: [
            ...
            CircleAvatar(
              ...
              child: const Icon(Icons.admin_panel_settings, size: 40, color: Colors.redAccent),
            ),
            ...
            Container(
              ...
              child: const Text('ADMIN', style: TextStyle(color: Colors.redAccent, fontSize: 12, fontWeight: FontWeight.bold, letterSpacing: 1)),
            ),
            const SizedBox(height: 40),
