  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Buyer Login', style: TextStyle(fontFamily: 'serif', fontWeight: FontWeight.bold)),
      ),
      body: Center(
          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 16),
                TextButton(
                  onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const BuyerSignupScreen())),
